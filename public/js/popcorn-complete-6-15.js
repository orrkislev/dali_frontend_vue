...
(function( Popcorn, window, document ) {
  ...
  function HTMLYouTubeVideoElement( id ) {
    ...
    function onPlayerReady( event ) {
    	try
    	{
    		player.setPlaybackRate(Number(player.b.b.speed)); // ORIT Mar. 19. if speed is set as a number  - use it.
    	}
    	catch (err) {}
    ...
    function changeSrc( aSrc ) {
      ...
      // Get duration value.
      impl.duration  = 1000; // ORIT: june 15, following change in youtube interface
      Popcorn.getJSONP( xhrURL, function( resp ) {
        ...
        player = new YT.Player( elem, {
          width: "100%",
          height: "100%",
          speed: self.parentNode.attributes.speed.value, // Orit: Mar. 19
